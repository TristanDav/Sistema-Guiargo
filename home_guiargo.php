...
try {
    ...
    if ($conexion && !$conexion->connect_error) {
        ...
        // Contar seguimientos del usuario actual
        $stats['seguimientos'] = getCount($conexion, 'seguimientos', 'id_usuario_asignado = ' . intval($_SESSION['usuario_id']));
        
        // Contar seguimientos pendientes del usuario actual
        $stats['seguimientos_pendientes'] = getCount($conexion, 'seguimientos', 'id_usuario_asignado = ' . intval($_SESSION['usuario_id']) . ' AND estatus = "Pendiente"');
    }
} catch (Exception $e) {
...
<head>
    ...
    <link rel="stylesheet" href="css/home_guiargo.css">
...
<body>
    ...
    <main class="main-content">
        ...
        <section class="dashboard-grid">
            ...
            <div class="dashboard-card" onclick="window.location.href='seguimientos.php'">
                <div class="card-header">
                ...
                <div class="card-number"><?php echo $stats['seguimientos_pendientes']; ?></div>
                <p class="card-description">Seguimientos pendientes</p>
            </div>
        </section>
